...
ActiveRecord::Schema.define(version: 2020_04_11_222710) do
  ...
  create_table "places", force: :cascade do |t|
    ...
    t.index ["service_id", "service_identifier"], name: "index_places_on_service_id_and_service_identifier", unique: true
  ...
  create_table "services", force: :cascade do |t|
    ...
    t.index ["issues"], name: "index_services_on_issues", using: :gin
